...
class DivKitPreviewRunConfiguration(
        project: Project,
    ...
    var divKitPreviewMethodFqn: String? = null
    ...
    override fun getRefactoringElementListener(element: PsiElement): RefactoringElementListener? {
        ...
        val pathFromElement = KotlinStandaloneScriptRunConfigurationProducer.pathFromPsiElement(file) ?: return null
        ...
        return object : RefactoringElementAdapter() {
            override fun undoElementMovedOrRenamed(newElement: PsiElement, oldQualifiedName: String) {
                setupFilePath(KotlinStandaloneScriptRunConfigurationProducer.pathFromPsiElement(newElement) ?: return)
            }
...
private class ScriptCommandLineState(
        ...
        configuration: DivKitPreviewRunConfiguration
) : BaseJavaApplicationCommandLineState<DivKitPreviewRunConfiguration>(environment, configuration) {
...
private fun VirtualFile.module(project: Project): Module? {
    if (org.jetbrains.kotlin.idea.util.ProjectRootsUtil.isProjectSourceFile(project, this)) {
