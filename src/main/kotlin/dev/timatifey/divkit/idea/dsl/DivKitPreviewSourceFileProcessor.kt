...
class DivKitPreviewSourceFileProcessor {
    companion object {
        const val GENERATED_OUTPUT_PREFIX = "##divkit##generated##"
        const val LINES_INFO_MARKER = "end##"
        const val END_OUTPUT_MARKER = "end##!@#%^&*"

        const val OBJECT_NAME = "DivKitPreviewFileRunnerGenerated"
        const val INSTANCE_NAME = "instanceDivKitPreviewFileRunner"
        const val PACKAGE_NAME = "dev.timatifey.divkit.idea.dsl.generated"
